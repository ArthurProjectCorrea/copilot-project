...
| ------------------------------------------- | -------------- | -------------- | -------------------------- | ----------------- |
| [`src`](#src)                               | <!-- Cross --> | <!-- Check --> | String or Array of Objects | Yes               |
| [`weight`](#weight)                         | <!-- Check --> | <!-- Check --> | String or Array            | Required/Optional |
| [`style`](#style)                           | <!-- Check --> | <!-- Check --> | String or Array            | -                 |
| [`subsets`](#subsets)                       | <!-- Check --> | <!-- Cross --> | Array of Strings           | -                 |
| [`axes`](#axes)                             | <!-- Check --> | <!-- Cross --> | Array of Strings           | -                 |
| [`display`](#display)                       | <!-- Check --> | <!-- Check --> | String                     | -                 |
| [`preload`](#preload)                       | <!-- Check --> | <!-- Check --> | Boolean                    | -                 |
| [`fallback`](#fallback)                     | <!-- Check --> | <!-- Check --> | Array of Strings           | -                 |
| [`adjustFontFallback`](#adjustfontfallback) | <!-- Check --> | <!-- Check --> | Boolean or String          | -                 |
| [`variable`](#variable)                     | <!-- Check --> | <!-- Check --> | String                     | -                 |
| [`declarations`](#declarations)             | <!-- Cross --> | <!-- Check --> | Array of Objects           | -                 |
