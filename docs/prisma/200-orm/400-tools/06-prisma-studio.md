...
| :------------------------: | -------------------------------------------------------------------------------------------------------------------------- |
|  <!-- StudioStringSvg -->  | Text                                                                                                                       |
|  <!-- StudioNumberSvg -->  | Integer                                                                                                                    |
| <!-- StudioDatetimeSvg --> | Date-time<!-- br --><!-- br -->                                                                                            |
| <!-- StudioBooleanSvg -->  | Boolean<!-- br -->                                                                                                         |
|   <!-- StudioEnumSvg -->   | Pre-defined list of values (`enum` data type)                                                                              |
|  <!-- StudioArraySvg -->   | List of related records from another model                                                                                 |
|  <!-- StudioObjectSvg -->  | The `{}` symbol can refer to one of the two types of fields.<!-- br --><!-- br --> • Relation field<!-- br -->• JSON field |
...
:::info
**Note**<!-- br --><!-- br -->
With Prisma Studio open, you can open the keyboard shortcuts modal by pressing <!-- kbd -->Cmd &#8984;+<!-- kbd -->/ on macOS or <!-- kbd -->Ctrl+<!-- kbd -->/ on Windows.
:::
...
- <!-- kbd -->Cmd &#8984; + <!-- kbd -->C&nbsp;&nbsp;&nbsp;on macOS
- <!-- kbd -->Ctrl + <!-- kbd -->C&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;on Windows

To paste in another cell, first double-click the cell to enter edit mode, and then use:

- <!-- kbd -->Cmd &#8984; + <!-- kbd -->V&nbsp;&nbsp;&nbsp;on macOS
- <!-- kbd -->Ctrl + <!-- kbd -->V&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;on Windows
...
2. Based on the data allowed in each field, type the data for the record.
   ...
   | :------------------------: | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
   |  <!-- StudioStringSvg -->  | Text                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
   |  <!-- StudioNumberSvg -->  | Integer<!-- br --><!-- br -->If such a field has `autoincrement()` pre-filled, do not edit the cell and do not add a number manually.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
   | <!-- StudioDatetimeSvg --> | Date-time<!-- br --><!-- br -->Date-time fields contain a long string of numbers, letters, and others. As a best practice, copy the value of another date-time cell and modify it as necessary before pasting in the field.                                                                                                                                                                                                                                                                                                                                                                                                            |
   | <!-- StudioBooleanSvg -->  | Boolean<!-- br --><!-- br -->Select `true` or `false`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
   |   <!-- StudioEnumSvg -->   | Pre-defined list<!-- br --><!-- br -->Double-click a cell in the field and select one of the pre-defined options.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
   |  <!-- StudioArraySvg -->   | List of related records from another model<!-- br --><!-- br -->It typically refers to a list of records that exist in another model in the database. If you are adding a new record and records from the related model do not yet exist, you do not need to enter anything in the current model.                                                                                                                                                                                                                                                                                                                                      |
   |  <!-- StudioObjectSvg -->  | The `{}` symbol can refer to one of the two types of fields.<!-- br --><!-- br --> • Relation field<!-- br -->• JSON field<!-- br --><!-- br -->**Relation with a model defined separately in the database**<!-- br --><!-- br -->Typically, you need to select the same value as any of the previous records<!-- br -->Click the name of the model to see the list of values which you can then select for the related field.<!-- br --><!-- br -->**JSON field**<!-- br --><!-- br --> Double-click the field to edit the JSON data. As a best practice, validate the edited JSON data in a validator and paste it back in the cell. |
