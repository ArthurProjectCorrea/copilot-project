...
<!-- summary -->Expand if you want to keep using your Prisma 1 CLI side-by-side
...
Press the <!-- kbd -->Y button, then confirm by hitting <!-- kbd -->RETURN on your keyboard to continue.
...
- If you are following the gradual side-by-side upgrade strategy, do not perform these changes yet since they will break your Prisma 1 setup. In that case, you can continue to the next phase of the Upgrade CLI by typing <!-- kbd -->n and hitting <!-- kbd -->RETURN.
- If you are following the all at once upgrade strategy, you can perform these changes now. In that case, continue by typing <!-- kbd -->Y and hitting <!-- kbd -->RETURN.
...
At this point, you've resolved the schema incompatibilities with the Upgrade CLI. You can now exit the Upgrade CLI for now by typing <!-- kbd -->n and hitting <!-- kbd -->RETURN.
...
If you did not resolve all schema incompatibilities, the Upgrade CLI now prints the remaining SQL statements (as well as the ones for migrating IDs). You can just ignore them at this point and continue to the last step by continuously typing <!-- kbd -->Y and hitting <!-- kbd -->RETURN when prompted.
...
One more time, type <!-- kbd -->Y and hit <!-- kbd -->RETURN to confirm.
...
One last time, type <!-- kbd -->Y and hit <!-- kbd -->RETURN to confirm.
