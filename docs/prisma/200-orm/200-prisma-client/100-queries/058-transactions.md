...
| :------------------ | :---------------------------------------------------------------------------------------------------------------------- |
| Dependent writes    | <!-- ul --><!-- li -->Nested writes                                                                                     |
| Independent writes  | <!-- ul --><!-- li -->`$transaction([])` API<!-- li -->Batch operations                                                 |
| Read, modify, write | <!-- ul --><!-- li -->Idempotent operations<!-- li -->Optimistic concurrency control<!-- li -->Interactive transactions |
