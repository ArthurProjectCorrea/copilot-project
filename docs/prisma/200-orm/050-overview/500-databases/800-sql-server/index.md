...
| :-------------------------------------------------------------------------------------------- | :---------------- | :----------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <!-- ul --><!-- li -->`database`<!-- li -->`initial catalog`                                  | No                | `master`           | The database to connect to.                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| <!-- ul --><!-- li -->`username`<!-- li -->`user`<!-- li -->`uid`<!-- li -->`userid`          | No - see Comments |                    | SQL Server login (such as `sa`) _or_ a valid Windows (Active Directory) username if `integratedSecurity` is set to `true` (Windows only).                                                                                                                                                                                                                                                                                                                                     |
| <!-- ul --><!-- li -->`password`<!-- li -->`pwd`                                              | No - see Comments |                    | Password for SQL Server login _or_ Windows (Active Directory) username if `integratedSecurity` is set to `true` (Windows only).                                                                                                                                                                                                                                                                                                                                               |
...
| <!-- ul --><!-- li -->`loginTimeout`<!-- li -->`connectTimeout`<!-- li -->`connectionTimeout` | No                |                    | Number of seconds to wait for login to succeed.                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
| <!-- ul --><!-- li -->`ApplicationName`<!-- li -->`Application Name`(case insensitive)        | No                |                    | Sets the application name for the connection. Since version 2.28.0.                                                                                                                                                                                                                                                                                                                                                                                                           |
