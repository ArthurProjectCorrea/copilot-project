...
See the [Prisma schema API reference](/orm/reference/prisma-schema-reference) <!-- span --> for detailed information about each section of the schema.
...
- Run the [`prisma format`](/orm/reference/prisma-cli-reference#format) <!-- span --> command.
